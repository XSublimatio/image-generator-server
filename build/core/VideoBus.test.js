...
var import_VideoBus = __toESM(require("./VideoBus"));
let queueItemBus;
let videoBus;
...
import_tap.default.test("Test onNewQueueItem", (t) => {
  t.before(() => __async(exports, null, function* () {
    ...
    videoBus = new import_VideoBus.default();
  ...
  t.test("Should return hello world", (t2) => __async(exports, null, function* () {
    ...
    videoBus.on("newVideo", (receivedTokenId, imagePath) => {
      ...
      t2.equal(`${process.env.PWD}/build/output/${tokenId}.mp4`, imagePath);
    });
  }));
});
//# sourceMappingURL=VideoBus.test.js.map
