...
var VideoBus_exports = {};
__export(VideoBus_exports, {
  default: () => VideoBus_default
});
...
class VideoBus extends import_tiny_typed_emitter.TypedEmitter {
  constructor() {
    super();
  ...
  createImg(queueItem) {
    return __async(this, null, function* () {
      ...
      `);
        this.emit("newVideo", queueItem.tokenId, `${process.env.PWD}/build/output/${queueItem.tokenId}.mp4`);
      } catch (e) {
...
var VideoBus_default = VideoBus;
const processName = (name) => name.toLowerCase().replace("-", "").split(" ")[0];
module.exports = __toCommonJS(VideoBus_exports);
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {});
//# sourceMappingURL=VideoBus.js.map
